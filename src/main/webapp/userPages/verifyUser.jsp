...
<div class="container">
    ...
    <form action="/MindGauge/UserRegister" method="post">
...
function goToHome() {
    if (confirm("Back to Home?")) {
        window.location.href = "/MindGauge/userPages/userRegister.jsp";
    }
}
</script>
...
<%
    ...
    response.sendRedirect("/MindGauge/userPages/userRegister.jsp");
}
%>
