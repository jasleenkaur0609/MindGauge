...
<div class="d-lg-flex half">
    <div class="bg order-1 order-md-2" style="background-image: url('../mg1.jpeg');"></div>
    <div class="contents order-2 order-md-1">
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-md-7">
                    <h1>Register as <br><strong><span style="color: #006D77; font-size: 4rem;">User</span></strong></h1>
                    <form action="/MindGauge/VerifyUser" method="post" onsubmit="return validateForm()">
                    ...
                    <div class="text-center">
                        <a href="/MindGauge/home.jsp" class="btn-link">Back to Home</a>
                        <a href="/MindGauge/userPages/userLogin.jsp" class="btn-link">Already a User, Login</a>
                    </div>
                </div>
            </div>
        </div>
