...
<body>
	...
	<header>
		...
		<div class="header-buttons">
			<a href="/MindGauge/adminPages/addTest.jsp">Add New Test</a> 
	...
	<script>
		function editTest(testId) {
			...
			form.setAttribute('action', '/MindGauge/EditTest');
		...
		function deleteTest(testId) {
			if (confirmTestDeletion()) {
				window.location.href = "/MindGauge/DeleteTest?what=test&test_id=" + testId;
			}
		}
	...
	<%
		...
		response.sendRedirect("/MindGauge/adminPages/adminLogin.jsp");
	%>
