...
<div class="container mt-4 p-4 shadow rounded bg-white">
    ...
    <form id="questionForm" action="/MindGauge/DummyQues" method="post">
    ...
    <form id="editQuestionForm" action="/MindGauge/UpdateTest" method="post">
...
<%
        ...
        response.sendRedirect("/MindGauge/login.jsp");
    }
%>
