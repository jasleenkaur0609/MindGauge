...
<body>
        ...
        <form action="../AddTest" method="post">
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="topic" name="topic" placeholder="Max 100 characters" required maxlength="100">
                </div>
    ...
    <script>
        function redirectToDashboard() {
            window.location.href = '/MindGauge/AdminDashboard';
        }
    </script>
